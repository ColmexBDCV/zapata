...
function queue_timeline_assets()
{
    ...
    if ($useInternalJs) {
        ...
        $headScript->appendFile(src('timeline-api.js', 'javascripts/simile/timeline-api'));
       	...
       	/*$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/timeline-api.js?bundle=true');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/scripts/l10n/es/labellers.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/scripts/l10n/en/labellers.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/simile-ajax-api.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/simile-ajax-bundle.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/timeline-api.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/timeline-bundle.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/scripts/l10n/es/timeline.js');
       	$headScript->appendFile('http://zapatavive.colmex.mx/themes/avantgarde/javascripts/simile/scripts/l10n/en/timeline.js');*/
