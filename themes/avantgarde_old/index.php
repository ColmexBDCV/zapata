...
<div id="secondary">
	<div id="search-container">
		...
		<style>
			@media all and (max-height:850px){#content{top:11%;}}
			@media all and (max-height:750px){#content{top:7%;}}
			#content{top:15%;padding:0!important;}
		</style>
		
		<form id="advanced-search-form" name="search-form" action="/items/browse" method="get">    
			<input type="text" name="search" id="query" value="" title="Search" placeholder="Type here and press Enter">        
			...
			<div class="inputs">
				<div class="search-entry">
					...
					<label id="descripcion_label" for="descripcion">Descripci&oacute;n <input type="hidden" name="advanced[0][type]" value="contains"></div>
			</div>
