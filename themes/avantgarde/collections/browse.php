...
<div class="collection">
    ...
    <p class="view-items-link"><?php echo link_to_items_browse(__('Ver elementos', metadata('collection', array('Dublin Core', 'Title'))), array('collection' => metadata('collection', 'id'))); ?></p>
