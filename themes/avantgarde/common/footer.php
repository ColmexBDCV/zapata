    ...
    <div id="footer-content" class="center-div">
        ...
        <div id="custom-footer-text">
			...
			<p class="credits">
				<a href="http://biblioteca.colmex.mx">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/logo_biblioteca.png" id="logo_biblioteca" target="_blank"/></a>
				<a href="http://www.fundacionzapata.org.mx/">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/logo_zapata.png" id="logo_zapata" target="_blank"/></a>
				<a href="http://morelos.gob.mx/">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/logo_morelos.png" id="logo_morelos" target="_blank"/></a>
				<a href="http://ceh.colmex.mx/">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/logo-CEH.png" id="logo_ceh" target="_blank"/></a>
				<a href="http://www.inah.gob.mx/es/">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/inah.png" id="logo_inah" target="_blank"/></a>
				<a href="http://www.fundacionzapata.org.mx/">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/fundacionzap.png" id="logo_fundacion" target="_blank"/></a>
				<a href="http://www.filmoteca.unam.mx/">
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/FILMOTECA_UNAM.png" id="logo_filmoteca" target="_blank"/></a>
				<a>
					<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/logo_EJERCITO-LIBERTADOR.png" id="logo_ejercito" target="_blank"/></a>
			</p>
        </div>
        <?php endif; ?>
        ...
        <?php endif; ?>
			...
			<a href="https://es-la.facebook.com/Biblioteca-Daniel-Cos%C3%ADo-Villegas-199117690545/">&nbsp;&nbsp;&nbsp;
				<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/facebook-icon.png" id="facebook" target="_blank"/>
			</a>
			<a href="https://twitter.com/bibliocolmex?lang=es">&nbsp;&nbsp;&nbsp;
				<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/twitter-icon.png" id="twitter" target="_blank"/>
			</a>
			</p>
			<span id="copyright">
				...
				<img src="<?php echo $this->baseUrl();?>/themes/avantgarde/images/copyright.png" id="copyright_img" target="_blank"/></a>
			</span>
...
<script type="text/javascript">
    jQuery(document).ready(function(){
		...
		function combatientes(){
			...
			/* reemplazar la url de la relacion por la foto del veterano (ver footer_anterior.php) */
		}
		...
		if( window.location.href.indexOf("neatline") > -1 ){
			...
			//jQuery('#neatline-map #dublin-core-relation .element-text').css('cssText','display:block!important;');
		}
	});
</script>
...
<?php
	...
	if( 
		current_url() == get_pathconf().'/'   // Arreglar problemas con el footer en alturas específicas
	){
		echo "
			<script>
